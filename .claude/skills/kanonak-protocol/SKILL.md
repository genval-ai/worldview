...
license: Apache-2.0
compatibility: Requires npm (for installing the CLI) and network access to npmjs.com plus the publisher domains of any Kanonak packages being read or installed.
